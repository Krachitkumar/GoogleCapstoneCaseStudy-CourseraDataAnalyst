...
## Introduction
In this case study, I will perform many real-world tasks of a junior data analyst at a fictional company, Cyclistic. In order to answer the key business questions, I will follow the steps of the data analysis process: [Ask](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/README.md#ask), [Prepare](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/README.md#prepare), [Process](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/README.md#process), [Analyze](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/README.md#analyze-and-share), [Share](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/README.md#analyze-and-share), and [Act](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst#act).
### Quick links:
Data Source: [divvy_tripdata](https://divvy-tripdata.s3.amazonaws.com/index.html) [accessed on 04/03/23]  
  
SQL Queries:  
[01. Data Combining](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/01.%20Data%20Combining.sql)  
[02. Data Exploration](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/02.%20Data%20Exploration.sql)  
...
### Combining the Data
SQL Query: [Data Combining](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/01.%20Data%20Combining.sql)  
12 csv files are uploaded as tables in the dataset '2022_tripdata'. Another table named "combined_data" is created, containing 5,667,717 rows of data for the entire year. 
### Data Exploration
SQL Query: [Data Exploration](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/02.%20Data%20Exploration.sql)  
...
### Data Cleaning
SQL Query: [Data Cleaning](https://github.com/Krachitkumar/GoogleCapstoneCaseStudy-CourseraDataAnalyst/blob/main/03.%20Data%20Cleaning.sql)  
